  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="flex flex-col flex-wrap lg:py-6 -mb-0 lg:w-1/2 lg:pl-12 lg:text-left text-center">
      ...
      <div class="flex flex-col mb-0 lg:items-start items-center">
	   ...
	   <div class="container px-15 py-15 mx-auto flex flex-wrap">
    <div class="lg:w-2/3 w-full mb-0 lg:mb-0 rounded-lg overflow-hidden">
    </div>
	  <form method="get" action="my_requests.php">
			<input type="hidden" name="varname" value="<?php echo $row['user_id'] ?>">
			<button type="submit" name="buy_requests" class="flex mx-3 mt-6 text-white bg-purple-500 border-0 py-2 px-5 focus:outline-none hover:bg-purple-600 rounded">My Requests</button>
		</form>  
	  <button name="sale_items" class="flex mx-3 mt-6 text-white bg-purple-500 border-0 py-2 px-5 focus:outline-none hover:bg-purple-600 rounded"><a href="my_items_on_sale.php">My Items</a></button>
      <button name="logout" class="flex mx-3 mt-6 text-white bg-purple-500 border-0 py-2 px-5 focus:outline-none hover:bg-purple-600 rounded"><a href="logout.php">Log Out</a></button>
	 </div>  
</section>
