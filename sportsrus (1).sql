...
CREATE TABLE `user` (
  ...
  `u_image` int(11) DEFAULT NULL,
  `phno` int(10) UNSIGNED NOT NULL,
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
