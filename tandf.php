...
<html>
	...
	<div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Track and Field</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-700">Buy second-hand track and field equipment here.</p>
    </div>
	
	<?php
	
	$sql = "SELECT * FROM product where category_id = 200005";
