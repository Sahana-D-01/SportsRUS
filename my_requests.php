<?php 
	...
	$uid = $_GET['varname']; 
	$query = "SELECT * FROM product p, request b WHERE p.product_id = b.product_id and b.user_id ='{$uid}'";
...
<html>
	...
	<h2 style="font-size: 35px;" class="lg:text-center mt-8 mb-3 text-xl font-semibold tracking-widest text-black uppercase title-font">Products I Requested For</h2>
