...
<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            ...
            <a href="team.html" class="mr-5 hover:text-gray-900">Our Team</a>
            <a href="categories.html" class="mr-5 hover:text-gray-900">Marketplace</a>
                ...
                <div class="flex flex-wrap -m-5">
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="price" pattern="^\d{0,8}(\.\d{1,4})?$" name="prod_price" id="prod_price" placeholder="Price in INR " class="w-full px-4 py-2 mt-2 text-base transition duration-500 ease-in-out transform bg-gray-100 border-transparent rounded-lg focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ext-black focus:border-gray-500" autofocus autocomplete required>
                        </div>
                    </div>
                    ...
                    <div class="pr-2 pl-2 pb-2 w-full">
                        <div class="relative">
                            <label class="block text-base font-medium leading-relaxed text-gray-700">Product Category</label>
                    ...
                    <div class="pr-2 pl-2 pb-2 w-full">
                        <div class="relative">
                            ...
                            <button class="mx-auto border-0 py-2 focus:outline-none font-semibold text-black transition duration-500 ease-in-out transform rounded-lg bg-gradient-to-r">
                                <input type="file" name="prod_img" id="prod_img" accept="image/png, image/gif, image/jpeg" required>
                            </button>
                        </div>
                    </div>
                    <div class="p-2 w-full">
                        <button type="submit" class="flex mx-auto border-0 py-2 px-8 focus:outline-none font-semibold text-white transition duration-500 ease-in-out transform rounded-lg bg-gradient-to-r from-black hover:from-black to-black focus:outline-none hover:to-black">Submit</button>
                    </div>
                </div>
            </div>
        </form>
